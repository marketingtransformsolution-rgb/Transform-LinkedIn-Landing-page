        ...
        <div className="reveal" style={{ transitionDelay: '0.2s' }}>
          <div className="bg-white border border-slate-100 rounded-[2.5rem] shadow-xl shadow-slate-200/50 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-8 lg:p-12 space-y-10 border-b md:border-b-0">
                ...
                <ul className="space-y-0">
                  {[
                    ...
                    <li key={i} className={`flex gap-4 items-center h-[80px] ${i !== 2 ? 'border-b border-slate-50' : ''}`}>
                      <div className="bg-rose-50 p-1.5 rounded-full">
                        <XCircle className="w-5 h-5 text-rose-500 shrink-0" strokeWidth={2.5} />
                      </div>
                      <span className="text-[15px] font-medium text-slate-500 leading-tight">{text}</span>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="bg-blue-50/40 p-8 lg:p-12 space-y-10 border-l border-slate-50">
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                ...
                <ul className="space-y-0">
                  {[
                    ...
                    <li key={i} className={`flex gap-4 items-center h-[80px] ${i !== 2 ? 'border-b border-blue-100/50' : ''}`}>
                      <div className="bg-blue-100 p-1.5 rounded-full">
                        <CheckCircle2 className="w-5 h-5 text-blue-600 shrink-0" strokeWidth={2.5} />
                      </div>
                      <span className="text-[15px] font-bold text-slate-900 leading-tight">{text}</span>
                    </li>
                  ))}
                </ul>
              </div>
