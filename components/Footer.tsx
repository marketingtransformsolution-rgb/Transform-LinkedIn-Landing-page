  ...
  return (
    <footer className="bg-white text-slate-500 py-20 border-t border-slate-100">
      <div className="max-content">
        ...
        <div className="mt-20 pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4 text-[9px] uppercase font-bold tracking-[0.2em] text-slate-400">
