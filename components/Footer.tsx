      ...
      <div className="max-content">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
          ...
          <div className="space-y-6">
            ...
            >
              <div className="w-8 h-8 bg-blue-600 rounded flex items-center justify-center font-black text-white text-lg">
                T
              </div>
            ...
            <p className="text-sm leading-relaxed max-w-xs">
              Human-in-the-loop data annotation services for production-grade
              AI. Bridging the gap between raw data and model intelligence.
            </p>
          </div>
        ...
        <div className="mt-16 md:mt-20 pt-6 md:pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4 text-[9px] uppercase font-bold tracking-[0.2em] text-slate-400">
