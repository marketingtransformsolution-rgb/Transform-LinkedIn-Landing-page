                        ...
                        <div>
                            <div className="reveal" style={{ transitionDelay: '0.05s' }}>
                                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-50 border border-red-100 mb-6">
                                    ...
                                    <span className="text-[10px] font-black text-red-700 uppercase tracking-widest">Text &amp; NLP Annotation</span>
                                </div>
                            </div>
                            <div className="reveal" style={{ transitionDelay: '0.1s' }}>
                                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.25rem] xl:text-6xl font-extrabold tracking-tight leading-[1.07] text-slate-900 mb-6 sm:mb-8">
                                    ...
                                    <span className="text-red-600">scalable language AI</span>
                                </h1>
                            </div>
                            <div className="reveal space-y-5" style={{ transitionDelay: '0.18s' }}>
                                ...
                                <p className="text-base sm:text-lg text-slate-500 leading-relaxed">
                                    As LLM training datasets grow, semantic interpretation becomes harder to standardize. What begins as a manageable workflow quickly evolves into a bottleneck.{' '}
                                    <span className="text-red-600 font-bold">TRANSFORM</span> provides managed text and NLP annotation operations designed to support enterprise language AI through structured governance, human-in-the-loop validation, and scalable delivery.
                                </p>
