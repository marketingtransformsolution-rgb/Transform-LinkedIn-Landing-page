...
import { ChevronDown, CheckCircle, ArrowRight, Camera, Shield, Zap, Target, Users, BarChart3, X } from 'lucide-react';
...
const ImageVideoAnnotationPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const containerId = 'hs-modal-img-video';
        const load = () => {
            if (window.hbspt) {
                ...
                <div className="px-20 w-full relative z-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-10 lg:gap-16 items-start">
                        ...
                        <div className="reveal w-full order-last lg:order-none mt-10 lg:mt-0 lg:self-stretch flex flex-col" style={{ transitionDelay: '0.25s' }}>
                            <img
                                src="/image video annotation/data-labeling-services.webp"
